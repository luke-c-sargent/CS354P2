...
OgreApp_SOURCES = Ball.cpp BaseApplication.cpp Court.cpp Game.cpp GameObject.cpp Player.cpp Simulator.cpp SoundEffects.cpp Ball.h config.h Court.h Game.h GameObject.h OgreMotionState.h Player.h Simulator.h SoundEffects.h
